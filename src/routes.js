...
const Profile ={
    data:{
        name: "Erickson",
        avatar: "https://avatars.githubusercontent.com/u/63134236?v=4",
        "monthly-budget": 3000,
        "days-per-week": 5,
        "hours-per-day":5,
        "vacation-per-year": 4,
            ...
            const updatedJobs = Job.data.map((job) => {
             //ajustes no job   
                ...
                return {
                    ...
                    remaining,
                    status,
                    budget: Profile.data["value-hour"] * job["total-hours"] //Job.services.calculateBudget(job, Profile.data["value-hour"])
                }
                })
